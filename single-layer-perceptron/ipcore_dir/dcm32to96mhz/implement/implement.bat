...
xst -ifn xst.scr
move dcm32to96mhz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm32to96mhz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm32to96mhz_exdes.ucf dcm32to96mhz_exdes

echo 'Running map'
map -timing -pr b dcm32to96mhz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dcm32to96mhz_exdes -w routed.ncd routed.v
cd ..
